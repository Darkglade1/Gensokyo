...
public class YingYangFox extends AbstractPet {
    ...
    public static final String move2 = MOVES[2] + block + MOVES[3];
    public static final String move3 = MOVES[4] + heal + MOVES[5];
    ...
    protected void addMoves(){
        ...
        moves.addMove(new MinionMove(DIALOG[1], this, new Texture("GensokyoResources/images/monsters/Animals/Intents/defend.png"), move2, () -> {
