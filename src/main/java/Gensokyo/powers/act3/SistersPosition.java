...
public class SistersPosition extends AbstractPower {

    public static final String POWER_ID = GensokyoMod.makeID("SistersPosition");
    ...
    public SistersPosition(AbstractCreature owner, int amount, boolean ally) {
        name = NAME;
        ID = POWER_ID;
