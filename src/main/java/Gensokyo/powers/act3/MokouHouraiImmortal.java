...
public class MokouHouraiImmortal extends AbstractPower {

    public static final String POWER_ID = GensokyoMod.makeID("MokouHouraiImmortal");
    ...
    public MokouHouraiImmortal(AbstractCreature owner, int amount) {
        name = NAME;
        ID = POWER_ID;
