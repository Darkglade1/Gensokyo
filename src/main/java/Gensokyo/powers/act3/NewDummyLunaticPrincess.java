...
public class NewDummyLunaticPrincess extends AbstractPower {

    public static final String POWER_ID = GensokyoMod.makeID("NewDummyLunaticPrincess");
    ...
    public NewDummyLunaticPrincess(AbstractCreature owner) {
        name = NAME;
        ID = POWER_ID;
