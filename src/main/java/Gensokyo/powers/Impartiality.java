...
public class Impartiality extends AbstractPower {

    public static final String POWER_ID = GensokyoMod.makeID("Impartiality");
    ...
    public Impartiality(AbstractCreature owner) {
        name = NAME;
        ID = POWER_ID;
