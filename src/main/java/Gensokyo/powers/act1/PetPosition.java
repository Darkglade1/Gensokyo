...
public class PetPosition extends AbstractPower {

    public static final String POWER_ID = GensokyoMod.makeID("PetPosition");
    ...
    public PetPosition(AbstractCreature owner) {
        name = NAME;
        ID = POWER_ID;
