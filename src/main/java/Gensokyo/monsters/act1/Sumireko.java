...
public class Sumireko extends CustomMonster
{
    ...
    private static final int GUN_ACT_DAMAGE_BONUS = 6;
    private static final int A3_GUN_DAMAGE = 13;
    private static final int PYROKINESIS_DAMAGE = 8;
    private static final int PYROKINESIS_ACT_DAMAGE_BONUS = 4;
    private static final int A3_PYROKINESIS_DAMAGE = 9;
    private static final int BURN_AMT = 1;
    private static final int A18_BURN_AMT = 2;
    private static final int BLOCK = 10;
    private static final int BLOCK_ACT_BONUS = 5;
