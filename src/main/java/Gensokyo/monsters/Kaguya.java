...
public class Kaguya extends CustomMonster
{
    ...
    private static final int BUDDHIST_DIAMOND_DAMAGE_1 = 7;
    private static final int A4_BUDDHIST_DIAMOND_DAMAGE_1 = 8;
    private int buddhistDiamondDamage1;

    private static final int BUDDHIST_DIAMOND_DAMAGE_2 = 6;
    ...
    private static final int A4_BUDDHIST_DIAMOND_DAMAGE_5 = 10;
    ...
    private static final int A9_HP = 42;
