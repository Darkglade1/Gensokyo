...
public class Mokou extends CustomMonster
{
    ...
    public void usePreBattleAction() {
        ...
        request.transform();
        addToBot(new ApplyPowerAction(this, this, new HouraiImmortal(this, DEATH_THRESHOLD)));
        addToBot(new ApplyPowerAction(this, this, new DummyLunaticPrincess(this, strengthGain)));
        addToBot(new ApplyPowerAction(AbstractDungeon.player, this, new LunaticPrincess(AbstractDungeon.player, strengthGain, this, request)));
