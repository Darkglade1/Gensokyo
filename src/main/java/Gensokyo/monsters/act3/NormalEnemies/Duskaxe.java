...
public class Duskaxe extends AbstractSpriterMonster
{
    public static final String ID = GensokyoMod.makeID("Duskaxe");
    ...
    private static final int A17_STRENGTH = 6;
    ...
    public Duskaxe(final float x, final float y) {
        super(NAME, ID, HP_MAX, -5.0F, 0, 230.0f, 255.0f, null, x, y);
        this.animation = new BetterSpriterAnimation("GensokyoResources/images/monsters/Duskaxe/Spriter/DuskaxeAnimation.scml");
