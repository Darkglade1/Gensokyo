...
public class GreaterFairy extends CustomMonster
{
    ...
    static {
        ...
        NAME = GreaterFairy.monsterStrings.NAME;
        MOVES = GreaterFairy.monsterStrings.MOVES;
        DIALOG = GreaterFairy.monsterStrings.DIALOG;
    }
}