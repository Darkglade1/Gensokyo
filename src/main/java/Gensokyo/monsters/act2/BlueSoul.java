...
public class BlueSoul extends CustomMonster
{
    ...
    public BlueSoul(final float x, final float y, Yuyuko yuyuko) {
        super(NAME, ID, HP_MAX, 0.0F, 0, 150.0f, 130.0f, null, x, y);
