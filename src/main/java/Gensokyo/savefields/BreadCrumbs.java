...
import static Gensokyo.GensokyoMod.getModID;
...
public class BreadCrumbs implements CustomSavable<Map<Integer, String>>,
    ...
    private void loadLocStrings(String language) {
        ...
        BaseMod.loadCustomStringsFile(ScoreBonusStrings.class, getModID() + "Resources/localization/eng/GensokyoMod-score_bonuses.json");
    }
