...
public abstract class AbstractShopSpecialCard extends AbstractDefaultCard {
    public static TextureAtlas.AtlasRegion[] frames;
    public static final CardColor COLOR = GensokyoMod.Enums.SHOP_SPECIAL;
    public AbstractShopSpecialCard(final String id,
                                   final String img,
                                   final int cost,
                                   final CardType type,
