...
public class ScarletDevilMansionEvent extends AbstractImageEvent {


    public static final String ID = GensokyoMod.makeID("ScarletDevilMansionEvent");
    ...
    public ScarletDevilMansionEvent() {
