...
public class BorderOfDeathEvent extends AbstractImageEvent {


    public static final String ID = GensokyoMod.makeID("BorderOfDeathEvent");
    ...
    protected void buttonEffect(int buttonPressed) { // This is the event:
        switch (screenNum) {
            ...
            case 1:
                ...
                this.imageEventText.setDialogOption(OPTIONS[2]); // Make donation
