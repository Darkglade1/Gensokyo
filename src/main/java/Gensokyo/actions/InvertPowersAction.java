    ...
    public void update() {
        for (AbstractPower power : target.powers) {
            if (power instanceof StrengthPower) {
                ...
                AbstractDungeon.actionManager.addToTop(new RemoveSpecificPowerAction(target, target, VulnerablePower.POWER_ID));
                ...
                AbstractDungeon.actionManager.addToTop(new RemoveSpecificPowerAction(target, target, WeakPower.POWER_ID));
                ...
                AbstractDungeon.actionManager.addToTop(new RemoveSpecificPowerAction(target, target, LoseStrengthPower.POWER_ID));
